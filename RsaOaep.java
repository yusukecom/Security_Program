...
public class RsaOaep {
    public static void main(String[] args) throws Exception {
        ...
        String data = args[0];
        byte[] enc = ENCRYPT(data.getBytes(), PUBLIC_KEY_TEXT);
        byte[] dec = DECRYPT(enc, PRIVATE_KEY_TEXT);
    ...
    // 暗号化関数
    public static byte[] ENCRYPT(byte[] data, String PUBLIC_KEY_TEXT) throws Exception {
        // 公開鍵データをbyte配列に変換
